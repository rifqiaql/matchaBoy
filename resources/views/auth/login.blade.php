        ...
        <div class="card">
            ...
            <form method="POST" action="{{ route('login') }}" style="margin-top:18px">
                ...
                <div class="form-group">
                    ...
                    <input id="email" type="email" class="form-input" name="email" value="{{ old('email') }}" required autofocus placeholder="name@teahouse.com">
                    @if ($errors->has('email'))
                ...
                <div class="form-group">
                    ...
                    @if (Route::has('password.request'))
                        <div style="margin-top:8px;">
                            <a href="{{ route('password.request') }}" class="small" style="color:#56705a">Forgot Password?</a>
                        </div>
                    @endif
                </div>

                <div style="display:flex; align-items:center; gap:8px; margin-top:6px;">
                    <label style="display:flex; align-items:center; gap:8px; font-size:13px; color:#6b7a6b"><input type="checkbox" name="remember"> Keep me signed in for 30 days</label>
                </div>
